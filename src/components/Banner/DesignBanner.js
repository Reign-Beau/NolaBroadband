                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-12 text-center seo_banner_content">
                            <Reveal effect="fadeInUp" duration={500}><h2>NOLA Broadband</h2></Reveal>
                            <Reveal effect="fadeInUp" duration={1000}><p className="wow fadeInUp" data-wow-delay="0.5s">A reliable wireless internet service provider.<br/> Made in New Orleans for locals, by locals.</p></Reveal>
                            <Reveal effect="fadeInLeft" duration={1200}><a href="/Service" className="seo_btn seo_btn_one btn_hover wow fadeInLeft">Residential</a></Reveal>
                            <Reveal effect="fadeInLeft" duration={1200}><a href="/BusinessService" className="seo_btn seo_btn_two btn_hover wow fadeInRight">Business</a></Reveal>
                        </div>
                    </div>
