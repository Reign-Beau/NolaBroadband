                                            ...
                                            <div className="col-lg-3 col-md-6">
                                                ...
                                                <a href="index.html" className="f-logo"><img src={require('../../img/logo.png')} alt=""/></a>
                                                    <div className="widget-wrap">
                                                        <p className="f_400 f_p f_size_15 mb-0 l_height34"><span>Email:</span> <a href="mailto:info@nolabroadband.com" className="f_400">info@nolabroadband.com</a></p>
                                                    ...
                                                    <form action="#" className="f_subscribe mailchimp" method="post">
                                                        <input type="text" name="EMAIL" className="form-control memail" placeholder="Email Updates"/>
