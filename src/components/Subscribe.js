            ...
            <React.Fragment>
                <section className="seo_subscribe_area">
                    ...
                    <div className="container">
                        <SeoTitle Title="Colocation Services" TitleP="We offer colocation services in our owned switch facilities"/>
                        <form action="#" className="row seo_subscribe_form">
                            <div className="input-group col-lg-5 col-md-5 col-sm-6">
                                <input type="url" name="website" id="website" placeholder="This needs to be changed" className="form-control"/>
                            </div>
                            <div className="input-group col-lg-5 col-md-4 col-sm-6">
                                <input type="email" name="email" id="emails" placeholder="To card format colocation info" className="form-control"/>
                            </div>
                ...
                {/* <section className="case_studies_area sec_pad">
                    <div className="container">
                        <SeoTitle Title="#Option for Scrolling#" TitleP="The full monty burke posh excuse my French Richard cheeky bobby spiffing crikey Why gormless, pear shaped.!"/>
                        <StudySlider/>
                    </div>
                </section> ###Do we need?? */}
                <section className="seo_fact_area sec_pad">
                    ...
                    <div className="container">
                        <SeoTitle Title='Over 800+ locals served & Still counting.'/>
                        <div className="seo_fact_info">
                            ...
                            <div className="seo_fact_item last">
                                <div className="text">
                                    ...
                                    <p>Percent Satisfaction Rating</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="seo_partner_logo_area sec_pad">
                    <div className="container">
                        <div className="seo_sec_title text-center mb_70">
                            <Fade bottom><h2>Relied on by local businesses, trusted by residents,<br/> and 100% local.</h2></Fade>
                        </div>
                ...
                <section className="seo_call_to_action_area sec_pad">
                    <div className="container">
                        <div className="seo_call_action_text">
                            <h2>Ready to get started?<br/> Fill out the form for a FREE Site Survey!</h2>
                            <a href="/Contact" className="about_btn">Get a free Survey</a>
                        </div>
                    </div>
                </section>
            </React.Fragment>
