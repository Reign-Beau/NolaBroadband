        ...
        <section className="h_security_area">
            <div className="container">
                ...
                <div className="row">
                    ...
                    <SecurityFeaturesItem itemClass="pl_70" image="security_4.png" Title="NolaBB Document Protector" pText="My good sir car boot super old owt to do with me say no biggie cheeky bugger"/>
                </div>
            </div>
        </section>
    )
